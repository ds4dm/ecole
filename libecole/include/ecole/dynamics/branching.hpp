...
class ECOLE_EXPORT BranchingDynamics :
	public EnvironmentDynamics<Defaultable<std::size_t>, std::optional<xt::xtensor<std::size_t, 1>>> {
public:
	...
	ECOLE_EXPORT auto step_dynamics(scip::Model& model, Defaultable<std::size_t> const& maybe_var_idx)
